...
<div class="flex flex-col justify-center items-center w-full">
    <div class="ml-64 -mt-5 py-5 flex flex-col justify-center items-center w-3.8/5">
        <div class="text-center px-10 py-3 bg-white rounded-xl h-52 -mt-10 z-10 w-2/3 judul mb-5">
            ...
            <div id="date-time" class=" text-xl"></div>
    ...
    <div class="ml-64 -mt-5 py-5 flex flex-col justify-center items-center w-3"></div>
        ...
        <div class="con flex items-center justify-center p-5 w-full gap-5">
            <div data-aos="fade-up" data-aos-duration="1000" class=" card w-52 h-96 bg-gradient-to-br from-purple-500 p-5 to-purple-300  flex-col flex justify-between items-center gap-5 rounded-lg">
            ...
            <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000" class="card w-52 h-96 bg-gradient-to-br from-purple-500 p-5 to-purple-300  flex-col flex justify-between items-center gap-5 rounded-lg">
                <div class="font-bold">ORGANIZERS</div>
                <img src="../../../public/assets/organisasi.png" alt="" class="mb-4 mt-3">
            ...
            <div data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000" class="card w-52 h-96 bg-gradient-to-br from-purple-500 p-5 to-purple-300  flex-col flex justify-between items-center gap-5 rounded-lg">
            ...
            <div data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000" class="card w-52 h-96 bg-gradient-to-br from-purple-500 p-5 to-purple-300  flex-col flex justify-between items-center gap-5 rounded-lg">
                <div class="font-bold">SPONSHORSHIP</div>
                <img src="../../../public/assets/sponsor.png" alt="">
                <p class="text-center text-sm font-normal">Pihak yang memberikan dana & fasilitas untuk acara </p>
